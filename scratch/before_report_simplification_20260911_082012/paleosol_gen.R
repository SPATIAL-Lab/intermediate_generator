...
if (!length(screen_data)) write.csv(data.frame(reason=character(), file_1=character(), file_2=character()),
  file.path(out_dir, "paleosol_duplicate_candidates.csv"), row.names=FALSE)
